                    ...
                    <div className="px-6 py-4 flex items-center justify-between border-l-[6px] border-l-orange-500">
                        ...
                        <div className="flex items-center gap-2">
                            <Link href="/inventory/cycle-counts">
                                <Button className="bg-black text-white hover:bg-zinc-800 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] uppercase font-bold text-xs tracking-wide hover:translate-y-[1px] hover:shadow-none transition-all h-9 rounded-none">
                                    <ClipboardList className="mr-2 h-3.5 w-3.5" /> Opname Batch
                                </Button>
                            </Link>
                            <Button
                                onClick={() => setInputOpen(true)}
                                className="bg-orange-500 text-white border-2 border-orange-600 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all font-black uppercase text-xs tracking-wider px-6 h-9"
                            >
                    ...
                    <div className="grid grid-cols-3">
                        ...
                        <div className="relative p-4 md:p-5 border-r-2 border-zinc-100 dark:border-zinc-800">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs font-black uppercase tracking-widest text-zinc-500">Total Audit</span>
                            </div>
                            ...
                            <div className="flex items-center gap-1 mt-1.5">
                                <span className="text-xs font-bold text-zinc-500">Semua catatan</span>
                            </div>
                        </div>
                        ...
                        <div className="relative p-4 md:p-5 border-r-2 border-zinc-100 dark:border-zinc-800">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs font-black uppercase tracking-widest text-zinc-500">Sesuai</span>
                            </div>
                            <div className="text-2xl md:text-3xl font-black tracking-tighter text-emerald-600">
                                {isLoading ? "—" : matchCount}
                            </div>
                            <div className="flex items-center gap-1 mt-1.5">
                                <span className="text-xs font-bold text-emerald-600">Fisik = Sistem</span>
                            </div>
                        </div>
                        ...
                        <div className="relative p-4 md:p-5">
                            ...
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-xs font-black uppercase tracking-widest text-zinc-500">Selisih</span>
                            </div>
                            <div className="text-2xl md:text-3xl font-black tracking-tighter text-red-600">
                                {isLoading ? "—" : discrepancyCount}
                            </div>
                            <div className="flex items-center gap-1 mt-1.5">
                                <span className="text-xs font-bold text-red-600">Perlu investigasi</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
                    ...
                    <div className="bg-zinc-50 dark:bg-zinc-800 px-4 py-2.5 border-b-2 border-black flex items-center justify-between border-l-[5px] border-l-orange-500">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-black uppercase tracking-widest text-zinc-800 dark:text-zinc-200">Log Hasil Opname</span>
                        </div>
                        ...
                        <table className="w-full text-sm text-left">
                            <thead>
                                <tr className="bg-zinc-100 dark:bg-zinc-800 border-b-2 border-black">
                                    <th className="px-4 py-3 text-xs font-black uppercase tracking-widest text-zinc-500">Waktu</th>
                                    <th className="px-4 py-3 text-xs font-black uppercase tracking-widest text-zinc-500">Produk & Lokasi</th>
                                    <th className="px-4 py-3 text-xs font-black uppercase tracking-widest text-zinc-500 text-center">Fisik vs Sistem</th>
                                ...
                                {isLoading ? (
                                    <tr>
                                        <td colSpan={4} className="p-12 text-center">
                                            ...
                                            <p className="text-xs font-black uppercase tracking-widest text-zinc-400">Memuat data...</p>
                                        </td>
                                    </tr>
                                ) : pagedLogs.length === 0 ? (
                                    <tr>
                                        <td colSpan={4} className="p-12 text-center">
                                            ...
                                            <p className="text-xs font-black uppercase tracking-widest text-zinc-400">Belum ada data audit</p>
                                        </td>
                                    </tr>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                ...
                                                <div className="text-xs font-bold text-zinc-400 mt-0.5 flex items-center gap-1.5">
                                            ...
                                            <td className="px-4 py-3 text-center">
                                                <div className="flex items-center justify-center gap-3">
                                                    <div className="text-center">
                                                        <div className="text-xs uppercase font-black text-zinc-400 tracking-widest">Fisik</div>
                                                        <div className="text-lg font-black font-mono">{log.actualQty}</div>
                                                    </div>
                                                    <span className="text-zinc-300 font-black text-lg">/</span>
                                                    <div className="text-center">
                                                        <div className="text-xs uppercase font-black text-zinc-400 tracking-widest">Sistem</div>
                                            ...
                                            <td className="px-4 py-3 text-center">
                                                {log.status === 'MATCH' ? (
                                                    <span className="inline-block bg-emerald-50 text-emerald-700 border-2 border-emerald-600 text-xs font-black uppercase tracking-wider px-2.5 py-1">
                                                        SESUAI
                                                    </span>
                                                ) : (
                        ...
                        <ScrollArea className={NB.scroll}>
                            <div className="p-5 space-y-4">
                                ...
                                <div className={NB.section}>
                                    <div className={`${NB.sectionHead} border-l-4 border-l-orange-500 bg-orange-50`}>
                                ...
                                {/* Counting Section */}
                                <div className={NB.section}>
                                    <div className={`${NB.sectionHead} border-l-4 border-l-zinc-400 bg-zinc-50`}>
