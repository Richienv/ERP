...
export const navMain: SidebarNavItem[] = [
  ...
  },
  {
    ...
    moduleKey: "finance",
    items: [
      { title: "Invoice Pelanggan", url: "/finance/invoices", icon: IconFileInvoice, group: "Transaksi" },
      ...
      { title: "Tagihan Vendor", url: "/finance/bills", icon: IconReceipt, group: "Transaksi" },
      { title: "Bayar Vendor", url: "/finance/vendor-payments", icon: IconCreditCard },
      ...
      { title: "Bagan Akun", url: "/finance/chart-accounts", icon: IconSitemap },
...
export const breadcrumbLabels: Record<string, string> = {
  ...
  payables: "Hutang (AP)",
  bills: "Tagihan Vendor",
  "vendor-payments": "Bayar Vendor",
  "credit-notes": "Nota Kredit/Debit",
  "chart-accounts": "Bagan Akun",
